...
from SpeakLearnBot.games.base import GameStatus
from SpeakLearnBot.games.game_registry import game_registry
from SpeakLearnBot.games.session_manager import session_manager
from SpeakLearnBot.games import translate_word_quiz, russian_tutor, russian_cases_quiz, translator_game, watch_video, \
    speech_practice_quiz, verb_tense_quiz, verb_aspect_quiz, sing_along
from SpeakLearnBot.api.fake_bot import FakeBot, FakeMessage, FakeCallbackQuery
from SpeakLearnBot.api.schemas import (
    GameInfoSchema,
    GameStateSchema,
    ButtonSchema,
    StartGameRequest,
