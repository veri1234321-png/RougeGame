...
from SpeakLearnBot.games.base import BaseGame, GameSession, GameStatus
...
class LessonPhonetics(BaseGame):
    def __init__(self):
        super().__init__(game_id="phonetics_lesson")

    def get_display_name(self, lang: str) -> str:
        return translator.get_text("game_ph_btn_lesson", lang)
    ...
    async def _send_lesson_selection(
        ...
        for index, lesson in enumerate(PHONETICS_LESSONS_DATA):
            ...
            button_text = translator.get_text("game_phonetics_lesson_label" + str(index + 1), lang)
...
game_registry.register(LessonPhonetics())